 ...
 */
class GetNewUsers extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('ClientCertificates_GetNewUsers');
        $this->dimension     = new VisitorReturning();
        $this->documentation = Piwik::translate('New Users');
    ...
    public function configureView(ViewDataTable $view)
    {
        ...
        $view->config->addTranslation('label','Status');
    ...
    {
        $view = new View('@ClientCertificates/getNewUsers');
        $view->myData = array();
