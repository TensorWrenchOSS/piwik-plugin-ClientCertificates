...
class UserDN extends VisitDimension
{
    ...
    {
        return Piwik::translate('ClientCertificates_UserDN');
    }
    ...
    {
        $segment = new Segment();
        $segment->setSegment('user_dn');
        $segment->setCategory('General_Visit');
        $segment->setName('ClientCertificates_UserDN');
