...
class Email extends VisitDimension
{
    ...
    {
        return Piwik::translate('ClientCertificates_Email');
    }
    ...
    {
        $segment = new Segment();
        $segment->setSegment('email');
        $segment->setCategory('General_Visit');
        $segment->setName('ClientCertificates_Email');
