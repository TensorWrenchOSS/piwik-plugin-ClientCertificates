 ...
 *
 */
namespace Piwik\Plugins\ClientCertificates\Columns;
...
class FirstName extends VisitDimension
{
    ...
    {
        return Piwik::translate('ClientCertificates_FirstName');
    }
    ...
    {
        $segment = new Segment();
        $segment->setSegment('first_name');
        $segment->setCategory('General_Visit');
        $segment->setName('ClientCertificates_FirstName');
