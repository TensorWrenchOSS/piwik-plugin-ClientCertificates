...
class UID extends VisitDimension
{
    ...
    {
        return Piwik::translate('ClientCertificates_UID');
    }
    ...
    {
        $segment = new Segment();
        $segment->setSegment('uid');
        $segment->setCategory('General_Visit');
        $segment->setName('ClientCertificates_UID');
