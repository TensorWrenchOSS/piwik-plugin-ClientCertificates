...
class Agency extends VisitDimension
{
    ...
    {
        return Piwik::translate('ClientCertificates_Agency');
    }
    ...
    {
        $segment = new Segment();
        $segment->setSegment('agency');
        $segment->setCategory('General_Visit');
        $segment->setName('ClientCertificates_Agency');
